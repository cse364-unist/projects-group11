...
class LoadDatabase {
    ...
    CommandLineRunner initDatabase( MovieRepository movieRepository, UserRepository userRepository, RatingRepository ratingRepository, CosineSimilarityRepository cosineSimilarityRepository) {
        ...
        return args -> {
            List<List<String>> MovieData = readFile.readDAT("/root/project/milestone3/data/movies.dat");   // Load Movie Data
            ...
            List<List<String>> UserData = readFile.readDAT("/root/project/milestone3/data/users.dat");   // Load User Data
            ...
            List<List<String>> RatingData = readFile.readDAT("/root/project/milestone3/data/ratings.dat");   // Load Rating Data
