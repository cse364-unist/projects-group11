...
class LoadDatabaseTest {
    ...
    void testInitDatabase() throws Exception {
        ...
        when(readFile.readDAT("/root/project/milestone3/data/movies.dat")).thenReturn(movieData);
        when(readFile.readDAT("/root/project/milestone3/data/users.dat")).thenReturn(userData);
        when(readFile.readDAT("/root/project/milestone3/data/ratings.dat")).thenReturn(ratingData);
